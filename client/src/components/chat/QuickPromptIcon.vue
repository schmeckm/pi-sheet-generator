<template>
  <svg
    class="joule-suggestion-card__svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    stroke-width="1.75"
  ...
  >
    ...
    <template v-else-if="name === 'beaker'">
      <path d="M9 3h6M10 3v4l-5 9a2 2 0 0 0 1.7 3h10.6a2 2 0 0 0 1.7-3l-5-9V3" />
      <path d="M6 14h12" />
    </template>
    ...
    <template v-else-if="name === 'scale'">
      <path d="M12 3v18M5 8h14M7 8l-2 5h4l-2-5M17 8l-2 5h4l-2-5" />
    </template>
    <template v-else-if="name === 'factory'">
      <path d="M2 20h20M4 20V10l4 3V10l4 3V6l4 3v11" />
    </template>
    ...
    <template v-else-if="name === 'warehouse'">
      <path d="M3 9h18v10H3zM5 9V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v2M9 13h6" />
    </template>
    <template v-else-if="name === 'movement'">
